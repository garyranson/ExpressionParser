System.register([], function (exports_1, context_1) {
    ...
    var Literal, LiteralString, LiteralNumber, ScopedAccessorExpression, MemberAccessorExpression, MemberCallExpression, ConditionalExpression, UnaryExpression, CallExpression, ArrayExpression, ObjectExpression, BinaryExpression, LogicalExpression;
    return {
        setters: [],
        execute: function () {
            Literal = (function () {
